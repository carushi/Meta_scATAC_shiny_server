        ...
        tabItem(
            ...
            fluidPage(
                box(
                    ...
                    column(width=12,
                        p(
                            HTML('<a href="https://www.biorxiv.org/content/10.1101/2021.04.01.438068v2">Learning single-cell chromatin accessibility profiles using meta-analytic marker genes</a></br>
                            Risa Karakida Kawaguchi, Ziqi Tang, Stephan Fischer, Chandana Rajesh, Rohit Tripathy, Peter K. Koo, Jesse Gillis. bioRxiv 2021.04.01.438068; </br>doi: https://doi.org/10.1101/2021.04.01.438068')
                        )
                    ),
                ),
                box(
